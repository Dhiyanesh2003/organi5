<html>
	...
	<body>
		...
		<main>
			<div class="parallax-img"></div><br><br><br>
			<center><h1 class="tode">Today's Deals</h1></center>
			<div class="Deals">
				<div>
					<center>
			...
			<br><br><br>
			<center><h1 class="tode">Recipe Kits</h1></center>
			<div class="Deals">
				<div>
					<center>
		...
		<iframe width="350" height="430" allow="microphone;" src="https://console.dialogflow.com/api-client/demo/embedded/5876ca1a-09b7-4e3b-b84e-8d8c3e92222a"></iframe>
	</body>
</html>